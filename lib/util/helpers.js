...
class Helpers {
    ...
    static convertMiddlewareHooks(name, hooks) {
        return Helpers.convertMiddleware(hooks, name == agent_1.Hooks.OnSend ? IMiddleware_1.MiddlewareType.Data : name == agent_1.Hooks.OnError ? IMiddleware_1.MiddlewareType.Error : IMiddleware_1.MiddlewareType.MiddleWare);
    }
}
